...
public class DiscountServiceJPA {
    private static final Logger logger = Logger.getLogger(DiscountServiceJPA.class.getName());
    private final DiscountRepository repository;
    private final UserServiceJPA userService;
    private final DiscountApplicationServiceJPA discountApplicationService;
